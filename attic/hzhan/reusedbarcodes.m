...
load('barcodematrixZL235_Mseq130_SL.mat')       % load mapseq data

num_brain = 2;     % 10 brains in total

target_threshold = 10;       % UMI threshold for target site
injection_threshold = 50;       % UMI threshold for injection site

idx_injection = cell(1,num_brain);      % index of injection sites for each brain
idx_injection{1} = 46:47;
idx_injection{2} = 48:49;
