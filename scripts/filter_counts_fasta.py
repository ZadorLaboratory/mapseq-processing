...
if __name__ == '__main__':
    ...
    parser.add_argument('-n','--min_count', 
                        metavar='min_count',
                        required=False,
                        default=2,
                        type=int, 
                        help='Minimum counts to keep.')
    ...
    logging.info(f'handling {args.infile} to outdir {args.outfile}')
    ...
    filter_counts_fasta(cp, args.infile, 
                        args.outfile, 
